...
2. Configure Figma MCP (see .claude/docs/figma-mcp-integration.md)
...
- **Setup Guide:** `.claude/docs/figma-mcp-integration.md`
- **MCP Integration:** `.claude/docs/mcp-integration.md`
