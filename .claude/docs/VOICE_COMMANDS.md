...
**CCPM Feature:** ElevenLabs AI Voice Operations
**Version:** 1.0.0
...
voice:narrate "Hello CCPM team! Voice integration is working."
...
# 3. Output location
.claude/logs/audio/user_authentication_narration.mp3
...
- **Setup Guide:** `.claude/docs/guides/elevenlabs-integration.md`
- **Agent Documentation:** `.claude/agents/voice-operations.md`
