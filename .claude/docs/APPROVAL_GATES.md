...
- **Workflow Guide:** `.claude/docs/WORKFLOW_GUIDE.md` - Complete workflow documentation
- **Phase Guides:** `.claude/docs/phases/` - Detailed phase requirements
- **Agent Identification:** `.claude/docs/AGENT_IDENTIFICATION.md` - Agent signature format
- **CCPM Instructions:** `.claude/CLAUDE.md` - Core system guide
