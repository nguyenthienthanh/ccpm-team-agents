...
- **Smart Agent Detector:** `.claude/agents/smart-agent-detector.md`
- **Project Detector:** `.claude/agents/project-detector.md`
- **Agent Identification:** `.claude/docs/AGENT_IDENTIFICATION_GUIDE.md`
