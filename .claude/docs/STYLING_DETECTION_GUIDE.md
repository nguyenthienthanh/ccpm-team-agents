...
**Resources:**
- Skill: `.claude/skills/nativewind-component-generator.md`
...
- **Agent Guide:** `.claude/agents/mobile-react-native.md` → "Styling Conventions"
- **NativeWind Skill:** `.claude/skills/nativewind-component-generator.md`
