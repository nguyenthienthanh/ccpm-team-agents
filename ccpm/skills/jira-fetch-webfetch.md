...
Verify WebFetch permission in `settings.local.json`:
```json
{
  "permissions": {
    "allow": [
...
- **Agent:** `agents/jira-operations.md` - JIRA operations agent
- **Guide:** `docs/guides/JIRA_INTEGRATION.md` - Integration setup
- **Command:** `commands/workflow/start.md` - Workflow start command
- **Phase:** `commands/workflow/phase-1.md` - Phase 1 execution
