# 🔒 Security and Trust - CCPM Plugin
...
- ✅ Official repo: https://github.com/nguyenthienthanh/ccpm-team-agents
...
**Anyone can fork CCPM and create a malicious version!**

### How Attackers Work

1. **Fork the repository:**
   ```
   Original: nguyenthienthanh/ccpm-team-agents ✅ SAFE
...
## 🔍 What CCPM Has Access To

When you install CCPM, it can access:
...
### 🛡️ How Official CCPM Protects You
...
4. **Update carefully:**
   ...
   /plugin update ccpm@ethan-ccpm
   ```

5. **Report suspicious activity:**
   - Create issue: https://github.com/nguyenthienthanh/ccpm-team-agents/issues
   - Email: nguyenthienthanh.kiyoshi@gmail.com
...
- [ ] GitHub URL is exactly: `nguyenthienthanh/ccpm-team-agents`
- [ ] Repository owner is: **nguyenthienthanh**
- [ ] Plugin name is: **ccpm**
- [ ] Marketplace name is: **ethan-ccpm**
...
## 🆚 CCPM vs Malicious Forks

| Feature | Official CCPM | Malicious Fork |
|---------|---------------|----------------|
| **GitHub Owner** | nguyenthienthanh ✅ | random-user ⚠️ |
| **Repository** | ccpm-team-agents ✅ | ccpm-hacked ⚠️ |
...
**Official CCPM:**
- Repository: `nguyenthienthanh/ccpm-team-agents`
