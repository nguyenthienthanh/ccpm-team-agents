...
if [ "$MISSING_PROJECT_CONTEXT" = true ] || [ "$MISSING_CONFIG" = true ] || [ "$MISSING_SETTINGS" = true ] || [ "$MISSING_ENVRC" = true ]; then
  ...
  if [ "$MISSING_CONFIG" = true ]; then
    echo "   ❌ CCPM configuration (ccpm-config.yaml in plugin)"
  fi
  ...
  echo "   • Prepare CCPM for your tech stack"
  echo ""
  ...
  echo ""
  echo "⚠️  Continuing with default CCPM configuration..."
  echo ""
fi
```
...
```
╔════════════════════════════════════════════════════════════╗
║  ⚠️  CCPM Setup Incomplete                                ║
╚════════════════════════════════════════════════════════════╝

🔧 Missing components detected:

   ❌ Project context (.claude/project-contexts/)
   ❌ CCPM configuration (ccpm-config.yaml in plugin)
...
This will:
   ...
   • Prepare CCPM for your tech stack
