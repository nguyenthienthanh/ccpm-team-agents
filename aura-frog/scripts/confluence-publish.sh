#!/bin/bash
# Confluence Page Publish Script for Aura Frog
...
# Save response
mkdir -p logs/confluence
echo "$body" > "logs/confluence/page-${page_id}.json"
echo ""
echo "💾 Response saved to: logs/confluence/page-${page_id}.json"
echo ""
