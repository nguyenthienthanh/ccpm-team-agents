# Aura Frog Plugin Troubleshooting Guide

**Version:** 1.0.0
**Purpose:** Diagnose and fix Aura Frog plugin issues
...
If your Aura Frog plugin isn't working correctly, this guide will help you diagnose and fix common issues.
...
```markdown
**─────────────────────────────────────────────────────────**
🤖 **Agent:** pm-operations-orchestrator | 📋 **System:** Aura Frog v5.0
**─────────────────────────────────────────────────────────**
```
...
**When:** Using Aura Frog in a new project
...
/plugin list
# Should show: aura-frog@aurafrog
...
# Look for Aura Frog commands like:
# - workflow:start
# - project:init
# - agent:list

# If missing, reinstall plugin
/plugin install aura-frog@aurafrog --force
```
...
cp ~/.claude/plugins/marketplaces/aurafrog/aura-frog/project-contexts/template/* .claude/project-contexts/my-project/
...
chmod +x ~/.claude/plugins/marketplaces/aurafrog/aura-frog/scripts/*.sh

# 5. Test integration
bash ~/.claude/plugins/marketplaces/aurafrog/aura-frog/scripts/jira-fetch.sh TEST-123
```
...
```bash
#!/bin/bash
# verify-aura-frog-setup.sh

echo "🔍 Aura Frog Plugin Setup Verification"
echo "=================================="
echo ""
...
**Usage:**
```bash
chmod +x verify-aura-frog-setup.sh
./verify-aura-frog-setup.sh
```
...
This troubleshooting guide assumes Aura Frog is already installed and you're experiencing issues.
...
1. **Check Claude Code version**
   - Aura Frog requires Claude Code v1.0+
   - Check: /version
...
3. **Reinstall completely**
   ```bash
   /plugin uninstall aura-frog@aurafrog
   rm -rf ~/.claude/plugins/marketplaces/aurafrog/
   /plugin marketplace add nguyenthienthanh/aura-frog
   /plugin install aura-frog@aurafrog
   ```

4. **Check GitHub Issues**
   - Visit: https://github.com/nguyenthienthanh/aura-frog/issues
