...
Aura Frog uses a **layered rules system** that combines:
1. **Aura Frog Core Rules** (`rules/`) - Generic rules for all projects
...
```
Project Context Rules > Aura Frog Core Rules > Generic Defaults
```

**What this means:**
- ✅ Aura Frog core rules apply to ALL projects (universal best practices)
...
### Step 1: Load Aura Frog Core Rules
...
**Merge strategy:**
1. Start with Aura Frog core rules (base)
...
**Example merge:**
```markdown
# Aura Frog Core Rule (rules/theme-consistency.md)
...
## Theme Consistency
- Follows Aura Frog core rule: theme-consistency.md
- Exception: Brand colors in brand.ts (project-specific)

## TDD Workflow
- Follows Aura Frog core rule: tdd-workflow.md
- Additional: 80% coverage required (project standard)
```

### For Aura Frog Core Rules
...
**Summary:** Aura Frog combines core rules (universal) with project rules (specific), where project rules override core rules when they conflict. This gives you universal best practices with project-specific flexibility! ✨
