...
**Purpose:** Setup and use ElevenLabs AI voice generation in Aura Frog workflows

---

## 🎯 Overview

This guide will help you integrate ElevenLabs AI text-to-speech capabilities into your Aura Frog workflow system for documentation narration, voice notifications, and accessibility features.
...
Aura Frog automatically scans for sensitive data:
...
document guide "Getting Started with Aura Frog"
...
- Aura Frog Issues: https://github.com/anthropics/claude-code/issues
